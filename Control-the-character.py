...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
  while cap.isOpened():
    ...
    body = canvas.create_rectangle(sholder_x1, sholder_y1, sholder_x2, body_y2, fill = "red")
    ...
    canvas.create_oval(Lh_fingure_x1, Lh_fingure_y1, Lh_fingure_x2, Lh_fingure_y2, fill = "green")
    canvas.create_oval(Rh_fingure_x1, Rh_fingure_y1, Rh_fingure_x2, Rh_fingure_y2, fill="green")
    ...
    canvas.create_oval(Ll_fingure_x1, Ll_fingure_y1, Ll_fingure_x2, Ll_fingure_y2, fill="green")
    canvas.create_oval(Rl_fingure_x1, Rl_fingure_y1, Rl_fingure_x2, Rl_fingure_y2, fill="green")

    tk.update()
    time.sleep(0.01)
    canvas.delete('all')

    cv2.imshow('Rishaw', image)
